        ...
        <div className="space-y-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Step Content */}
              <div 
                className="flex-1 bg-white p-6 rounded-xl border-2 border-transparent hover:border-blue-900 shadow-lg hover:shadow-2xl transition-all duration-500 hover:shadow-[0_0_0_2px_rgb(30,58,138),0_0_20px_rgba(30,58,138,0.3)]"
              >
