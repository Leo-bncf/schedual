        ...
        <div className="space-y-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Step Content */}
              <div 
                className="flex-1 bg-white p-6 rounded-xl border-2 border-transparent hover:border-cyan-500 shadow-lg hover:shadow-2xl transition-all duration-500 hover:shadow-[0_0_0_2px_rgb(6,182,212),0_0_20px_rgba(6,182,212,0.3)]"
              >
