  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="flex justify-center mt-6">
        <div className={`bg-white/70 backdrop-blur-lg border border-slate-200/50 rounded-full transition-all duration-300 w-full max-w-5xl mx-4 ${isScrolled ? 'shadow-lg' : 'shadow-md'}`}>
