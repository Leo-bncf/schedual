      ...
      <div 
        ...
        style={{ 
          background: `linear-gradient(to bottom, 
            ...
            rgba(241, 245, 249, 0.58) 87%,
            rgba(236, 245, 254, 0.44) 90%,
            rgba(224, 242, 254, 0.32) 92%,
            rgba(207, 238, 254, 0.23) 94%,
            rgba(186, 230, 253, 0.16) 96%,
            rgba(147, 197, 253, 0.09) 97.5%,
            rgba(96, 165, 250, 0.04) 98.5%,
            rgba(59, 130, 246, 0.015) 99.5%,
