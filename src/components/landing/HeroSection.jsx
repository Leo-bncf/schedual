  ...
  return (
    <section className="relative min-h-screen pt-64 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center">
        ...
        >
          <div 
            className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border-2 border-transparent hover:border-blue-900 transition-all duration-500 hover:shadow-[0_0_0_2px_rgb(30,58,138),0_0_20px_rgba(30,58,138,0.3)]"
          >
