  ...
  return (
    <section className="relative min-h-screen pt-64 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center">
        ...
        >
          <div 
            className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border-2 border-transparent hover:border-sky-400 transition-all duration-500 hover:shadow-[0_0_0_2px_rgb(56,189,248),0_0_20px_rgba(56,189,248,0.3)]"
          >
            ...
            <div 
            className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border-2 border-transparent hover:border-cyan-400 transition-all duration-500 hover:shadow-[0_0_0_2px_rgb(34,211,238),0_0_20px_rgba(34,211,238,0.3)]"
          >
            <div className="w-14 h-14 bg-gradient-to-br from-blue-900 to-blue-800 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div 
            className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border-2 border-transparent hover:border-blue-400 transition-all duration-500 hover:shadow-[0_0_0_2px_rgb(96,165,250),0_0_20px_rgba(96,165,250,0.3)]"
          >
            <div className="w-14 h-14 bg-gradient-to-br from-blue-900 to-blue-800 rounded-xl flex items-center justify-center mx-auto mb-4">
