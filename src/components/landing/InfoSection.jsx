      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            const colors = [
              { border: 'hover:border-sky-400', shadow: 'hover:shadow-[0_0_0_2px_rgb(56,189,248),0_0_20px_rgba(56,189,248,0.3)]' },
              { border: 'hover:border-cyan-400', shadow: 'hover:shadow-[0_0_0_2px_rgb(34,211,238),0_0_20px_rgba(34,211,238,0.3)]' },
              { border: 'hover:border-blue-400', shadow: 'hover:shadow-[0_0_0_2px_rgb(96,165,250),0_0_20px_rgba(96,165,250,0.3)]' },
