          ...
          <div className="space-y-3">
            ...
            <div className="bg-slate-100 p-3 rounded-lg text-xs">
              ...
              <div className="space-y-1 text-slate-600">
                <div>Function: <code>callORToolScheduler</code></div>
                ...
                <div>Build version: {auditResult.buildVersion || 'unknown'}</div>
                <div>Wrapper version: {auditResult.wrapperBuildVersion || 'unknown'}</div>
                {auditResult.meta && (
