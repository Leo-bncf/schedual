...
export default function TeacherCardGrid({ teachers, getSubjectNames, onEdit, onDelete }) {
  ...
  const pendingTeacher = teachers.find(t => t.id === pendingDeleteId);
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem className="text-rose-600" onClick={() => setPendingDeleteId(teacher.id)}><Trash2 className="w-4 h-4 mr-2" />Delete</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete <strong>{pendingTeacher?.full_name}</strong>. Any teaching groups assigned to them will become unassigned. This cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
